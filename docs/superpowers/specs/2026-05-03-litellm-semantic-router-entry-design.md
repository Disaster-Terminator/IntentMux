...
`/home/raystorm/gateway/litellm/config.yaml`.
...
docker run -d --rm \
  ...
  -v /home/raystorm/gateway/gateway-semantic-router/spikes/semantic-router-litellm/sidecar-routes.yaml:/app/config/routes.yaml:ro \
...
docker run -d --rm \
  ...
  --network litellm_default \
  -p 4010:4010 \
  --env-file /home/raystorm/gateway/litellm/.env \
  -v /home/raystorm/gateway/gateway-semantic-router/spikes/semantic-router-litellm/litellm-proxy-config.yaml:/app/config.yaml:ro \
